...
static const _CarDecisionInterface_type_support_symbol_names_t _CarDecisionInterface_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interfaces, msg, CarDecisionInterface)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, car_interfaces, msg, CarDecisionInterface)),
  }
};
...
{
  return &::car_interfaces::msg::rosidl_typesupport_cpp::CarDecisionInterface_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, car_interfaces, msg, CarDecisionInterface)() {
  return get_message_type_support_handle<car_interfaces::msg::CarDecisionInterface>();
}
