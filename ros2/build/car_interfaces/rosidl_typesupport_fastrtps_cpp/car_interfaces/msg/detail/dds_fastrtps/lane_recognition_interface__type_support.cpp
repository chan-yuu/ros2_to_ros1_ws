...
#include "car_interfaces/msg/detail/lane_recognition_interface__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const car_interfaces::msg::LaneRecognitionInterface & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  car_interfaces::msg::LaneRecognitionInterface & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_car_interfaces
max_serialized_size_LaneRecognitionInterface(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const car_interfaces::msg::LaneRecognitionInterface *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_interfaces::msg::LaneRecognitionInterface *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneRecognitionInterface__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const car_interfaces::msg::LaneRecognitionInterface *>(
...
{
  return max_serialized_size_LaneRecognitionInterface(full_bounded, 0);
}

static message_type_support_callbacks_t _LaneRecognitionInterface__callbacks = {
  "car_interfaces::msg",
...
static rosidl_message_type_support_t _LaneRecognitionInterface__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneRecognitionInterface__callbacks,
...
{
  return &car_interfaces::msg::typesupport_fastrtps_cpp::_LaneRecognitionInterface__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interfaces, msg, LaneRecognitionInterface)() {
  return &car_interfaces::msg::typesupport_fastrtps_cpp::_LaneRecognitionInterface__handle;
}
