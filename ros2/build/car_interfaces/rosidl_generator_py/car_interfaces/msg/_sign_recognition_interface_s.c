...
bool car_interfaces__msg__sign_recognition_interface__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_interfaces.msg._sign_recognition_interface.SignRecognitionInterface", full_classname_dest, 71) == 0);
  }
  car_interfaces__msg__SignRecognitionInterface * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of SignRecognitionInterface */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_interfaces.msg._sign_recognition_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SignRecognitionInterface");
