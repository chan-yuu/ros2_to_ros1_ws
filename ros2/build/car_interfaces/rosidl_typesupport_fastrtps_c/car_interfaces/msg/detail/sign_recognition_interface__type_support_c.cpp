...
#include "car_interfaces/msg/detail/sign_recognition_interface__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // signdata
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // signdata
...
using _SignRecognitionInterface__ros_msg_type = car_interfaces__msg__SignRecognitionInterface;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SignRecognitionInterface__ros_msg_type * ros_message = static_cast<const _SignRecognitionInterface__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _SignRecognitionInterface__ros_msg_type * ros_message = static_cast<_SignRecognitionInterface__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_car_interfaces__msg__SignRecognitionInterface(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SignRecognitionInterface__ros_msg_type * ros_message = static_cast<const _SignRecognitionInterface__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SignRecognitionInterface__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_car_interfaces__msg__SignRecognitionInterface(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_car_interfaces
size_t max_serialized_size_car_interfaces__msg__SignRecognitionInterface(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_car_interfaces__msg__SignRecognitionInterface(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_SignRecognitionInterface = {
  "car_interfaces::msg",
...
static rosidl_message_type_support_t _SignRecognitionInterface__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SignRecognitionInterface,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_interfaces, msg, SignRecognitionInterface)() {
  return &_SignRecognitionInterface__type_support;
}
