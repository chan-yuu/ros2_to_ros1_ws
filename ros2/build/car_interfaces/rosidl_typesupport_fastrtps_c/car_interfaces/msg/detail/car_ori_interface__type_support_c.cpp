...
#include "car_interfaces/msg/detail/car_ori_interface__rosidl_typesupport_fastrtps_c.h"
...
using _CarOriInterface__ros_msg_type = car_interfaces__msg__CarOriInterface;

static bool _CarOriInterface__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CarOriInterface__ros_msg_type * ros_message = static_cast<const _CarOriInterface__ros_msg_type *>(untyped_ros_message);
...
static bool _CarOriInterface__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _CarOriInterface__ros_msg_type * ros_message = static_cast<_CarOriInterface__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_car_interfaces__msg__CarOriInterface(
  const void * untyped_ros_message,
...
static uint32_t _CarOriInterface__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_car_interfaces__msg__CarOriInterface(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_car_interfaces
size_t max_serialized_size_car_interfaces__msg__CarOriInterface(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _CarOriInterface__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_car_interfaces__msg__CarOriInterface(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_CarOriInterface = {
  "car_interfaces::msg",
  "CarOriInterface",
  _CarOriInterface__cdr_serialize,
  _CarOriInterface__cdr_deserialize,
  _CarOriInterface__get_serialized_size,
  _CarOriInterface__max_serialized_size
};

static rosidl_message_type_support_t _CarOriInterface__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CarOriInterface,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_interfaces, msg, CarOriInterface)() {
  return &_CarOriInterface__type_support;
}
