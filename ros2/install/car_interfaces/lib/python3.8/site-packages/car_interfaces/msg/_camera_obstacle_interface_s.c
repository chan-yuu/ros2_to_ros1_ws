...
bool car_interfaces__msg__camera_obstacle_interface__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_interfaces.msg._camera_obstacle_interface.CameraObstacleInterface", full_classname_dest, 69) == 0);
  }
  car_interfaces__msg__CameraObstacleInterface * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // number
    ...
    assert(PyLong_Check(field));
    ros_message->number = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // obstacledata
  ...
  {  // weatherdata
    PyObject * field = PyObject_GetAttrString(_pymsg, "weatherdata");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->weatherdata = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of CameraObstacleInterface */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_interfaces.msg._camera_obstacle_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraObstacleInterface");
  ...
  {  // weatherdata
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->weatherdata ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "weatherdata", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
