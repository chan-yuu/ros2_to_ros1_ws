...
{
  car_interfaces__msg__SonicStateInterface * msg = (car_interfaces__msg__SonicStateInterface *)malloc(sizeof(car_interfaces__msg__SonicStateInterface));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(car_interfaces__msg__SonicStateInterface));
  bool success = car_interfaces__msg__SonicStateInterface__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    car_interfaces__msg__SonicStateInterface__fini(msg);
  }
  free(msg);
}
...
car_interfaces__msg__SonicStateInterface__Sequence__init(car_interfaces__msg__SonicStateInterface__Sequence * array, size_t size)
{
  ...
  car_interfaces__msg__SonicStateInterface * data = NULL;
  if (size) {
    data = (car_interfaces__msg__SonicStateInterface *)calloc(size, sizeof(car_interfaces__msg__SonicStateInterface));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = car_interfaces__msg__SonicStateInterface__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        car_interfaces__msg__SonicStateInterface__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
car_interfaces__msg__SonicStateInterface__Sequence__fini(car_interfaces__msg__SonicStateInterface__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      car_interfaces__msg__SonicStateInterface__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  car_interfaces__msg__SonicStateInterface__Sequence * array = (car_interfaces__msg__SonicStateInterface__Sequence *)malloc(sizeof(car_interfaces__msg__SonicStateInterface__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = car_interfaces__msg__SonicStateInterface__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    car_interfaces__msg__SonicStateInterface__Sequence__fini(array);
  }
  free(array);
}
...
car_interfaces__msg__SonicStateInterface__Sequence__are_equal(const car_interfaces__msg__SonicStateInterface__Sequence * lhs, const car_interfaces__msg__SonicStateInterface__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!car_interfaces__msg__SonicStateInterface__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  car_interfaces__msg__SonicStateInterface__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(car_interfaces__msg__SonicStateInterface);
    car_interfaces__msg__SonicStateInterface * data =
      (car_interfaces__msg__SonicStateInterface *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!car_interfaces__msg__SonicStateInterface__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          car_interfaces__msg__SonicStateInterface__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!car_interfaces__msg__SonicStateInterface__copy(
