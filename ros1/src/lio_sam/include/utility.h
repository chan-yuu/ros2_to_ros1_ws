...
//    string path_save;
    ...
    ParamServer()
    {
        ...
        nh.param<float>("lio_sam/ang_bottom", ang_bottom, 15);
        nh.param<float>("lio_sam/ang_res_y", ang_res_y, 1);
        nh.param<std::string>("lio_sam/pointCloudTopic", pointCloudTopic, "points_raw");
        nh.param<std::string>("lio_sam/imuTopic", imuTopic, "imu_correct");
        // nh.param<std::string>("lio_sam/path_save", path_save, "/home/ubuntu/lio.txt");
