...
(cl:defclass <Pathplan> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector car_interfaces-msg:Pointplan)
   :initform (cl:make-array 0 :element-type 'car_interfaces-msg:Pointplan :initial-element (cl:make-instance 'car_interfaces-msg:Pointplan))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Pathplan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pathplan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_interfaces-msg:<Pathplan> is deprecated: use car_interfaces-msg:Pathplan instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Pathplan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_interfaces-msg:points-val is deprecated.  Use car_interfaces-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Pathplan>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'car_interfaces-msg:Pointplan))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pathplan>)))
  ...
  "9c4c89b7b017e468ad8dfddbec0bf5e6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pathplan)))
  "Returns md5sum for a message object of type 'Pathplan"
  "9c4c89b7b017e468ad8dfddbec0bf5e6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pathplan>)))
  ...
  (cl:format cl:nil "Pointplan[] points~%================================================================================~%MSG: car_interfaces/Pointplan~%float64 x~%float64 y~%float64 yaw~%float64 speed~%float64 kappa~%int8 gear~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pathplan)))
  "Returns full string definition for message of type 'Pathplan"
  (cl:format cl:nil "Pointplan[] points~%================================================================================~%MSG: car_interfaces/Pointplan~%float64 x~%float64 y~%float64 yaw~%float64 speed~%float64 kappa~%int8 gear~%~%~%~%"))
