...
(cl:defmethod cl:initialize-instance :after ((m <PlanTask-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanTask-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_interfaces-srv:<PlanTask-request> is deprecated: use car_interfaces-srv:PlanTask-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <PlanTask-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlanTask-request>)))
  ...
  "car_interfaces/PlanTaskRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlanTask-request)))
  "Returns string type for a service object of type 'PlanTask-request"
  "car_interfaces/PlanTaskRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PlanTask-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanTask-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_interfaces-srv:<PlanTask-response> is deprecated: use car_interfaces-srv:PlanTask-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <PlanTask-response>))
...
(cl:defmethod message-val ((m <PlanTask-response>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlanTask-response>)))
  ...
  "car_interfaces/PlanTaskResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlanTask-response)))
  "Returns string type for a service object of type 'PlanTask-response"
  "car_interfaces/PlanTaskResponse")
