...
class PathSpeedCtrlInterface(genpy.Message):
  _md5sum = "02bb193daca16799d8ba2ebb4fa7c792"
...
int8 flag_camera"""
  __slots__ = ['timestamp','Target_velocity','Target_steering_angle','Target_gear','Target_primary_gear','Target_EngineSpeedLevel','Target_speedlever_percentage','Target_Torque_Nm','Target_braking_percentage','NearestPoint_Car2Path','Cotton_Bin_Ctrl','CTE','dHead','brake_enable','value_brake','flag','UpDown','raw_control','kappa','x_trajectory','y_trajectory','gear','action','FY_Position','FY','IPC_En','UpDown_Position','flag_camera']
  _slot_types = ['float64','float32','float32','uint8','uint8','uint8','float32','float32','uint8','float32[]','int8','float32','float32','float32','float32','float32[]','uint8','float32','float32','float64','float64','int8','int8','float64','int8','int8','float32','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       timestamp,Target_velocity,Target_steering_angle,Target_gear,Target_primary_gear,Target_EngineSpeedLevel,Target_speedlever_percentage,Target_Torque_Nm,Target_braking_percentage,NearestPoint_Car2Path,Cotton_Bin_Ctrl,CTE,dHead,brake_enable,value_brake,flag,UpDown,raw_control,kappa,x_trajectory,y_trajectory,gear,action,FY_Position,FY,IPC_En,UpDown_Position,flag_camera
    ...
    if args or kwds:
      ...
      if self.kappa is None:
        self.kappa = 0.
      if self.x_trajectory is None:
        self.x_trajectory = 0.
      if self.y_trajectory is None:
        self.y_trajectory = 0.
      if self.gear is None:
        self.gear = 0
      if self.action is None:
        self.action = 0
      if self.FY_Position is None:
        self.FY_Position = 0.
      if self.FY is None:
        self.FY = 0
      if self.IPC_En is None:
        self.IPC_En = 0
      if self.UpDown_Position is None:
        self.UpDown_Position = 0.
      if self.flag_camera is None:
        self.flag_camera = 0
    else:
      self.timestamp = 0.
      self.Target_velocity = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B2f2d2bd2bfb().pack(_x.UpDown, _x.raw_control, _x.kappa, _x.x_trajectory, _x.y_trajectory, _x.gear, _x.action, _x.FY_Position, _x.FY, _x.IPC_En, _x.UpDown_Position, _x.flag_camera))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.UpDown, _x.raw_control, _x.kappa, _x.x_trajectory, _x.y_trajectory, _x.gear, _x.action, _x.FY_Position, _x.FY, _x.IPC_En, _x.UpDown_Position, _x.flag_camera,) = _get_struct_B2f2d2bd2bfb().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_B2f2d2bd2bfb = None
def _get_struct_B2f2d2bd2bfb():
    global _struct_B2f2d2bd2bfb
    if _struct_B2f2d2bd2bfb is None:
        _struct_B2f2d2bd2bfb = struct.Struct("<B2f2d2bd2bfb")
    return _struct_B2f2d2bd2bfb
_struct_b4f = None
def _get_struct_b4f():
    global _struct_b4f
