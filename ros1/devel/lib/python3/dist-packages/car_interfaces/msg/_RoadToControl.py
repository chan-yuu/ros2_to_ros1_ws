...
"""autogenerated by genpy from car_interfaces/RoadToControl.msg. Do not edit."""
import codecs
import sys
...
class RoadToControl(genpy.Message):
  _md5sum = "ba7de6d6e6f69a4d62782487a2d676e6"
  _type = "car_interfaces/RoadToControl"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 发给控制的路 相比nav_msgs/Path 多加了档位，混合A搜索自带档位标志
...
"""
  __slots__ = ['path','gear']
  _slot_types = ['nav_msgs/Path','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RoadToControl, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.gear = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
