...
"""autogenerated by genpy from car_interfaces/PathGlobal.msg. Do not edit."""
import codecs
import sys
...
class PathGlobal(genpy.Message):
  _md5sum = "b37aa2b40541c58a99e5b6f91bb685b0"
  _type = "car_interfaces/PathGlobal"
...
float64 w
"""
  __slots__ = ['timestamp','startpoint','goal_received','path']
  _slot_types = ['float64','float64[]','bool','nav_msgs/Path']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       timestamp,startpoint,goal_received,path
    ...
    """
    if args or kwds:
      super(PathGlobal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B3I().pack(_x.goal_received, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal_received, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.goal_received = bool(self.goal_received)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
